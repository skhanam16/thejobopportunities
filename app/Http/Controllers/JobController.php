...
class JobController extends Controller
{
    ...
    */
    ...
    //Hardcoded user ID, later will chang by authentication process
    ...
    {
        //Check if user is authorized permission is 'update'
        ...
        $validatedData = $request->validate([
            ...
            //Hardcoded user ID, later will change by authentication process
    ...
    public function destroy(Job $job): RedirectResponse
    {
        ...
        //Check if user is authorized permission is 'delete'
